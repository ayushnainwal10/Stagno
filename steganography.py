...
def encode():
	...
	img=ImageTk.PhotoImage(Image.open("theme/bg2.jpg"))
	...
	def back():
		enc.destroy()
		#execfile('python steganography.py')
		os.system('start steganography.exe')
		Popen('start steganography.exe')
...
def decode():
	...
	img=ImageTk.PhotoImage(Image.open("theme/bg3.jpg"))
	fontl = tkFont.Font(family='Algerian', size=32)
...
global image1
image1=ImageTk.PhotoImage(Image.open("theme/bg1.jpg"))
